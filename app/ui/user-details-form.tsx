...
const UserDetailsForm = (props: Props) => {
  ...
  return (
    <main className='grid grid-rows-12 h-full px-7 py-3'>
      <h1 className="row-start-1 row-end-2 text-lg font-semibold leading-6 text-gray-900">User details</h1>
      <div className='space-y-4 row-start-2 row-end-11 overflow-y-auto' >
        <form className='space-y-4 w-full max-w-xs sm:min-w-80'>
      ...
      <div className='flex flex-col gap-2 justify-center row-start-11 row-end-13'>
        <div className='h-4'>
          {showMessage && (
